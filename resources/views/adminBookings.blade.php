...
<head>
    ...
    <title>Admin Dashboard - Semua Booking</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="{{ route('admin.bookings') }}" class="menu-item active"><i class="fa-solid fa-calendar-check"></i> Booking</a>
    ...
    <main class="main-content">
        ...
        <header class="top-navbar">
            <form action="{{ route('admin.bookings') }}" method="GET" class="search-bar">
                <i class="fa-solid fa-magnifying-glass"></i>
                <input type="text" name="search" placeholder="Cari booking, user, lapangan..." value="{{ request('search') }}">
        ...
        <div class="page-content">
            <div class="page-header">
                <h1 class="page-title">Seluruh Log Booking</h1>
